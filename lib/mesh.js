class Bone {
    ...
    {
        //glMatrix.mat4.identity(this.finaltransformation);
        ...
        console.log(this.finaltransformation);
...
class Model {
    ...
    loopinside(root, globaltranformation)
    {
        ...
        if(this.meshes[0].bones.getBoneByName(root.name) != undefined)
        {
            
            var bone = this.meshes[0].bones.getBoneByName(root.name);
            
            if(root.name == "Kafa")
            {
                var rotate = glMatrix.mat4.create();
                glMatrix.mat4.rotate(globaltranformation, globaltranformation, glMatrix.glMatrix.toRadian(180),[1,1,0]);
            }
            if(root.name == "SolKol")
            {
                var rotate = glMatrix.mat4.create();
                glMatrix.mat4.rotate(globaltranformation, globaltranformation, glMatrix.glMatrix.toRadian(30),[1,1,0]);
            }
